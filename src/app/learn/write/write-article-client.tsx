...
interface WriteArticleClientProps {
  initialArticle?: ArticleData & { id: string };
}

export default function WriteArticleClient({ initialArticle }: WriteArticleClientProps) {
  const [input, setInput] = useState("");
  const [messages, setMessages] = useState<Message[]>(() =>
    initialArticle
      ? [{ role: "assistant", text: "Loaded existing draft. Give feedback to revise, or publish." }]
      : [],
  );
