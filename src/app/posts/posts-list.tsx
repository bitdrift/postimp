    ...
    <div className="flex flex-col h-[100dvh] bg-gray-100">
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="fixed top-0 right-0 bottom-0 w-64 bg-white z-50 shadow-xl flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3">
        ...
        {posts.map((post) => (
          <div
            key={post.id}
            className="w-full bg-white rounded-xl border p-3 flex items-start gap-3 text-left hover:bg-gray-50 transition-colors relative"
          >
            <button
